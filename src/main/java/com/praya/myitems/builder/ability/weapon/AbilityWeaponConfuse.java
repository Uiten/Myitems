...
public class AbilityWeaponConfuse extends AbilityWeapon implements AbilityWeaponAttributeBaseDamage, AbilityWeaponAttributeEffect {
   ...
   private AbilityWeaponConfuse(MyItems plugin, String id) {
      super(plugin, id);
   }

   public static final AbilityWeaponConfuse getInstance() {
      return AbilityWeaponConfuse.AbilityConfuseHelper.instance;
   }
   ...
   public int getMaxGrade() {
      ...
      AbilityWeaponProperties abilityWeaponProperties = abilityWeaponManager.getAbilityWeaponProperties("Confuse");
   ...
   // $FF: synthetic method
   AbilityWeaponConfuse(MyItems var1, String var2, AbilityWeaponConfuse var3) {
      this(var1, var2);
   }
   ...
   private static class AbilityConfuseHelper {
      ...
      static {
         MyItems plugin = (MyItems)JavaPlugin.getPlugin(MyItems.class);
         instance = new AbilityWeaponConfuse(plugin, "Confuse", (AbilityWeaponConfuse)null);
      }
   }
}
