...
public class LoreStatsWeapon {
   ...
   public LoreStatsWeapon(double damage, double penetration, double pvpDamage, double pveDamage, double attackAoERadius, double attackAoEDamage, double criticalChance, double criticalDamage, double hitRate) {
      this.damage = damage;
